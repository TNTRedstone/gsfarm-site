...
const E = globalThis.__sveltekit_1g6p781?.base ?? '',
    m = globalThis.__sveltekit_1g6p781?.assets ?? E,
    A = '1719788259614',
...
function P(t, e) {
    ...
    const o = t instanceof SVGAElement ? t.target.baseVal : t.target,
        a = !n || !!o || T(n, e) || (t.getAttribute('rel') || '').split(/\s+/).includes('external'),
        l = n?.origin === h && t.hasAttribute('download');
...
const K = { url: g({}), page: g({}), navigating: p(null), updated: R() };
export {
    U as H,
    L as N,
    N as P,
